 ...
 */
 function process(_data, options){
	...
	var classes = _data.classes; //class listings to process
	var classMeta = _data.classMeta; //class metadata to merge with the classes
...
export { formatDate, formatParameters, generateDate, parseDate, process, search };